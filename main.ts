...
function drinkicedteaonamountain () {
    game.showLongText("placeholder needs to be finished ", DialogLayout.Bottom)
}
...
function walk10miles () {
    scene.setBackgroundImage(img`
        ...
        1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
        `)
    game.showLongText("You climb up a mountain and end up in a snowfield", DialogLayout.Bottom)
    story.showPlayerChoices("drink iced tea", "make a snowman")
    if (story.checkLastAnswer("drink the iced tea")) {
        drink_iced_tea()
    } else {
        drinkicedteaonamountain()
    }
}
function makeasnowman () {
    scene.setBackgroundImage(img`
        ...
        1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
        `)
    game.showLongText("your snowman becomes your bestfriend", DialogLayout.Bottom)
}
